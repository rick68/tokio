use crate::runtime::task::{SpawnError, SpawnFailure};
...
cfg_rt! {
    ...
    #[track_caller]
    pub(super) fn spawn_inner<T>(future: T, name: Option<&str>) -> Result<JoinHandle<T::Output>, SpawnFailure<T::Output, SpawnError>>
    where
        T: Future + Send + 'static,
        T::Output: Send + 'static,
    {
